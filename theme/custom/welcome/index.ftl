...
<html>
<head>
    <title>Welcome to Spanugo</title>

    <meta charset="utf-8">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="noindex, nofollow">

    <link rel="shortcut icon" href="welcome-content/favicon.ico?v=2" type="image/x-icon">
...
<div class="wrapper">
    <div class="content">
        <div class="logo">
            <img src="welcome-content/ibm-logo.png" alt="IBM" width="200" border="0" />
        </div>
        <h1>Welcome to Spanugo</h1>
      ...
      <p>&copy; 2018 Spanugo Inc | All Rights Reserved</p>
